...
export function FrameStudio({
  ...
  return (
    <>
      ...
      {/* Vertically-centered chassis group. Identity strip is
          rendered ABOVE the bezel INSIDE the same w-fit container
          (via Chassis's identityStrip prop) so its text aligns to
          the chassis bezel's LEFT EDGE — operator request. */}
...
function Chassis({
  ...
  model: FrameModel
  slots: Slot[]
  /** Identity strip (FRM N + IP/Node/bay count) rendered ABOVE the
   *  bezel inside the same `w-fit mx-auto` container so the strip's
   *  text aligns to the chassis bezel's LEFT EDGE (operator request
   *  — the id shouldn't be at the page's left edge while the chassis
   *  is centered, they should line up). */
    ...
    <div className="relative w-full">
      <div className="overflow-x-auto pb-2">
        ...
        <div className="mx-auto w-fit">
          ...
          <div className="relative rounded-[14px] border border-white/[0.06] bg-[#2a2a2a] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
