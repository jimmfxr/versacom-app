          ...
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            {projects.length === 0 ? (
              <div className="rounded-2xl bg-[#2a2a2a] p-12 text-center">
                ...
                <p className="mt-4 text-base font-medium text-white">No active projects</p>
                <p className="mt-1 text-sm text-gray-400">Create a project first to manage equipment distribution.</p>
              </div>
            ) : (
              <>
                ...
                <div className="space-y-2">
                  {projects.map((project) => (
                    <div
                      key={project.id}
                      onClick={() => router.push(`/projects/${project.id}/distribution`)}
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1 text-xs text-gray-500">
                          {project.equipmentCount} equipment
                        </div>
                      </div>
