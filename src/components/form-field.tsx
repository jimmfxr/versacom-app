...
const fieldStyles = {
  false:
    'mt-1 w-full rounded-lg border-2 border-white/10 bg-[#202020] px-3 py-2 text-sm text-white outline-none transition-colors focus:border-[#0178a3]',
  true:
    'mt-0.5 w-full rounded border border-white/10 bg-[#202020] px-2 py-1 text-xs text-white outline-none focus:border-[#0178a3]',
}
